      ...
      <div className="container-custom">
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-4">
                ...
                >
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="url(#instagram-gradient-footer)">
                    <defs>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="text-center mb-6">
            <p className="text-sm text-gray-400 mb-2">{t.footer.developedBy}</p>
            <h4 className="text-lg font-semibold text-white mb-3">{t.footer.developer}</h4>
            <div className="flex justify-center gap-4 mb-4">
              ...
              <a 
                ...
                title="Instagram"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="url(#instagram-gradient-dev)">
                  <defs>
                    <linearGradient id="instagram-gradient-dev" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#f09433" />
                      <stop offset="25%" stopColor="#e6683c" />
                      <stop offset="50%" stopColor="#dc2743" />
                      <stop offset="75%" stopColor="#cc2366" />
          ...
          <div className="border-t border-gray-700 pt-6 text-center text-gray-400">
            <p className="text-sm">{t.footer.rights} {new Date().getFullYear()}</p>
          </div>
        </div>
      </div>
    </footer>
